...
kind: Kustomization
bases:
  - github.com/utilitywarehouse/gatekeeper-manifests/cluster?ref=3.1.0-beta.2-1
  - github.com/utilitywarehouse/gatekeeper-manifests/namespaced?ref=3.1.0-beta.2-1
```
